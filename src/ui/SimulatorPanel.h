...
private:
    ...
    void refreshState();
    // Append a UserInput marker at currentTimeMs. category is shared with
    // TimelineWidget's renderer (0=menu, 1=soft button, 2=trigger).
    void pushUserInput(int category, const QString& label);
